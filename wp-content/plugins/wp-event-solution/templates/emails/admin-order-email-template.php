    ...
    <tbody>
        ...
        <tr>
            ...
            <td
                ...
                "
            >
             <?php printf( '%s%s', esc_html( etn_currency_symbol() ), esc_html( $order->discount_total) ); ?>
        ...
        <?php 
            ...
            printf( '%s%s', esc_html( etn_currency_symbol() ), esc_html( floatval($order->total_price ) - floatval($discount_price) ) ); ?>
        </td>
        </tr>
    </tbody>
    </table>
