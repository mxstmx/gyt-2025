...
class Flow extends PostModel {
     ...
     * @return void
     */
    public function __construct( $flow = 0 ) {
    ...
    public static function all( $args = [] ) {
        $prefix_for_cpt = '_' . Config::get( 'general_prefix' ) . '_notification_flow_';
     ...
     * @return array
     */
    public static function total_flows_group_by_status() {
        $args = [
            'post_type'      => ( new self )->post_type,
            'posts_per_page' => -1,
            'post_status'    => 'any',
        ...
        $all_status = ens_get_post_status();
