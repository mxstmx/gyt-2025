...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'most' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'most' );
	?>
	<div class="ms-quantity">
		...
		<input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'most' ); ?>"
			size="4"
