...
use Eventin\Ens\Base\ForwardCalls;
...
abstract class PostModel {
    ...
    public function __get( $name ) {
        ...
        throw new \Exception( esc_html( sprintf( __( 'Undefined property %s', Config::get( 'text_domain' ) ), $name ) ) );
    }
    ...
    public function __set( $key, $value ) {
        if ( !isset( $this->data[$key] ) ) {
            // translators: %s is the name of the property
            throw new \Exception( esc_html( sprintf( __( 'Undefined property %s', Config::get( 'text_domain' ) ), $key ) ) );
        }
