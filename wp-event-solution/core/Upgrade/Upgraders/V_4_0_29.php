		...
		public function run() {
			...
			try {
				$schedule1 = $this->seed_schedule([
					'etn_schedule_title' => 'SEO & Content Marketing Strategies',
				...
				$schedule2 = $this->seed_schedule([
					'etn_schedule_title' => 'Emerging Technologies & Innovation Trends',
				...
				$this->seed_event([
					'post_title' => 'Digital Marketing Summit 2025',
				...
				$this->seed_event([
					'post_title' => 'Annual Tech Innovators Conference  ',
